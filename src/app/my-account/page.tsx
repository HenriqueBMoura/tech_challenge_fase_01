...
export default function MinhaContaPage() {
  ...
  // Controla a view ativa para o sidebar
  const [activeView, setActiveView] = useState('minha-conta');
      ...
      <main className="max-w-7xl mx-auto px-4 py-10">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <Sidebar 
            ...
            navItems={[
              { href: "overview", label: "Início", isActive: false },
              { href: "minha-conta", label: "Minha Conta", isActive: true },
              { href: "seguranca", label: "Segurança", isActive: false },
              { href: "notificacoes", label: "Notificações", isActive: false }
            ]}
          />
